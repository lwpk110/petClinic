...
import cn.tendata.samples.petclinic.data.jpa.config.CustomImplicitNamingStrategy;
import cn.tendata.samples.petclinic.data.jpa.config.CustomPhysicalNamingStrategy;
...
public class JpaConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		factory.setPackagesToScan("cn.tendata.samples.petclinic.data.jpa.domain");
